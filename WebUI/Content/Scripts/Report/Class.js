...
initTable = function (queryData) {
    $("#grid").datagrid({
        ...
        columns: [[
            ...
            { field: "ParentName", title: "专业", width: 180, sortable: true },
            { field: "Name", title: "班级", width: 180, sortable: true },
        ...
        url: "../Report/GetClassList", sortName: "ClassID", sortOrder: "asc",
        toolbar: buttonStr
    });
}
