...
initTable = function (queryData) {
    $("#grid").datagrid({
        ...
        columns: [[
            { field: "ParentName", title: "学校", width: 180, sortable: true },
            { field: "Name", title: "校区", width: 180, sortable: true },
        ...
        url: "../Report/GetDeptList", sortName: "DeptID", sortOrder: "asc",
        toolbar: buttonStr
    });
}
...
bindSearchClickEvent = function () {
    ...
    $("#btnReset").click(function () {
        ...
        initTable({ Clear: clear, MenuID: menuId });
    });
}
