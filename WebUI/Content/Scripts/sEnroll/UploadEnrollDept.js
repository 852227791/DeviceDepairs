...
bindFormEvent = function () {
    Easy.UpLoadFilePreview("#enroll_file", 'uploadfileQueue5', "#gridEnrollDeptInfo", "#enrollDeptFilePath", "../sEnroll/GetUploadEnrollDeptExcel", "#upenrollLaout", "报名校区");
    $("#enrollDeptId").combotree({
...
bindStudentInfo = function () {
    $("#gridEnrollDeptInfo").datagrid({
        ...
        columns: [[
            ...
            { field: "校区", title: "校区", width: 80, sortable: false }]
        ],
        ...
        toolbar: [{
            ...
            text: '导出',
            handler: function () {
                Easy.DeriveFile("#gridInfo", "报名校区信息.xls");
            }
        }],
